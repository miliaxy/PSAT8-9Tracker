...
export const curriculumMap: CurriculumMapEntry[] = [
  ...
  {
    skillId: 'math-area-volume', section: 'Math', domain: 'Geometry',
  ...
  {
    skillId: 'math-lines-angles', section: 'Math', domain: 'Geometry',
    requiredConcepts: ['Parallel lines and angle relationships', 'Triangle angle relationships', 'Triangle congruence and similarity', 'Scale factors', 'Coordinate geometry with lines', 'Pythagorean theorem and right-triangle relationships'],
    ...
    doNotAssign: ['Formal Euclidean proofs as a prerequisite for PSAT 8/9 drills', 'Trigonometric ratios, circles, and other geometry topics not listed in the PSAT 8/9 framework'],
    priorResourceTitles: ['7th Grade Geometry', 'Ch 14: Geometry'],
  },
]
...
export const ixlBySkillId = new Map<string, CurriculumResource>([
  ...
  ['math-lines-angles', { provider: 'IXL', course: 'Geometry', unit: 'Lines, angles, triangles, similarity, and right-triangle relationships', url: IXL_GEOMETRY }],
])
